...
const ALGORITHMS = [
  ...
  },
  {
    ...
    stable: 'N/A',
    lecture: 'Lec 11',
    steps: ['1. Compute hash h(K) for key index', '2. If occupied, check index+1, index+2, ... mod m', '3. Probe sequentially until empty slot is found'],
    link: '/lecture/11#hashing-complexity',
  },
  {
    name: 'B-Trees',
    ...
    stable: 'N/A',
    lecture: 'Lec 11',
    steps: ['1. Start search at tree root node', '2. Binary search keys inside current node', '3. Follow child pointer corresponding to range', '4. Repeat until key is found or leaf is reached'],
